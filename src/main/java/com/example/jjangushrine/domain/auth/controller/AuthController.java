...
import com.example.jjangushrine.domain.auth.service.AuthService;
...
public class AuthController {
    ...
    public ResponseEntity<Void> userSignUp(
        ...
        authService.userSignUp(userSignUpReq);
    ...
    public ResponseEntity<Void> sellerSignUp(
        ...
        authService.sellerSignUp(sellerSignUpReq);
        return ResponseEntity.status(HttpStatus.CREATED).build();
    }
    ...
    public ResponseEntity<SignInRes> userSignIn(
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(authService.userSignIn(signInReq));
    }
    ...
    public ResponseEntity<SignInRes> sellerSignIn(
        ...
        return ResponseEntity.status(HttpStatus.OK)
                .body(authService.sellerSignIn(signInReq));
    }
}
